...
#   c) node1 mines 32 blocks, so now node 0 has 60001drip, node 1 has 4250drip, node2 has none.
#   d) node0 sends 601 drip to node2, in two transactions (301 drip, then 300 drip).
