Contributing to DRIP Core
============================

The DRIP Core project operates an open contributor model where anyone is
...
The following applies to code changes to the DRIP Core project, and is not to be
confused with overall DRIP Network Protocol consensus changes.

Whether a pull request is merged into DRIP Core rests with the project merge
...
Patches that change DRIP consensus rules are considerably more involved than
...
Where a patch set proposes to change the DRIP consensus, it must have been
...
The project leader is the release manager for each DRIP Core release.
