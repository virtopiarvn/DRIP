...
This issue tracker is only for technical issues related to DRIP Core.
General DRIP questions and/or support requests and are best directed to the [DRIP Discord](https://discord.dripcoin.tech).
...
### What version of DRIP Core are you using?
