...
RESOURCES += src/qt/drip.qrc src/qt/drip_locale.qrc

TRANSLATIONS += src/qt/locale/drip_bg.ts \
                src/qt/locale/drip_de.ts \
                src/qt/locale/drip_en.ts \
                src/qt/locale/drip_es.ts \
                src/qt/locale/drip_fi.ts \
                src/qt/locale/drip_fr.ts \
                src/qt/locale/drip_it.ts \
                src/qt/locale/drip_ja.ts \
                src/qt/locale/drip_pl.ts \
                src/qt/locale/drip_pt.ts \
                src/qt/locale/drip_ru.ts \
                src/qt/locale/drip_sk.ts \
                src/qt/locale/drip_sv.ts \
                src/qt/locale/drip_vi.ts \
                src/qt/locale/drip_zh_CN.ts \
                src/qt/locale/drip_zh_TW.ts
