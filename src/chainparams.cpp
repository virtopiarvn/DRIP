...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (54, uint256("0x000177075b30c98455b02303c83fd6123a6ff53fce06d6bd70f0de5131e80576"));

static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1525998103, // * UNIX timestamp of last checkpoint block
...
static Checkpoints::MapCheckpoints mapCheckpointsTestnet =
    boost::assign::map_list_of(0, uint256("0x0003160741317e8c35da276a913e0399dfae343d363a0d2d5c261095405968fa"));
...
static Checkpoints::MapCheckpoints mapCheckpointsRegtest =
    boost::assign::map_list_of(0, uint256("0x75cb05f3a9695135e1c9d056f68e1d5c6f90b4a04aa490393e6fcc3977790d5f"));
...
public:
	...
	assert(hashGenesisBlock == uint256("0x000300062a698d3734ce3be664ce734eb1ec654fa51edc8c37f75fb9e7fe8ca1"));
...
public:
    CTestNetParams()
    {
        ...
        genesis.nTime = 1525982600;
        genesis.nNonce = 1100;

        hashGenesisBlock = genesis.GetHash();

        assert(hashGenesisBlock == uint256("0x0003160741317e8c35da276a913e0399dfae343d363a0d2d5c261095405968fa"));
...
public:
    CRegTestParams()
    {
        ...
        nDefaultPort = 21465;
        assert(hashGenesisBlock == uint256("0x75cb05f3a9695135e1c9d056f68e1d5c6f90b4a04aa490393e6fcc3977790d5f"));
