...
extern UniValue setzdripseed(const UniValue& params, bool fHelp);
extern UniValue getzdripseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzdrip(const UniValue& params, bool fHelp);
extern UniValue dzdripstate(const UniValue& params, bool fHelp);
