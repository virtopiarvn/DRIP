...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* DRIP features */
        {"drip", "masternode", &masternode, true, true, false},
        {"drip", "listmasternodes", &listmasternodes, true, true, false},
        {"drip", "getmasternodecount", &getmasternodecount, true, true, false},
        {"drip", "masternodeconnect", &masternodeconnect, true, true, false},
        {"drip", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"drip", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"drip", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"drip", "masternodecurrent", &masternodecurrent, true, true, false},
        {"drip", "masternodedebug", &masternodedebug, true, true, false},
        {"drip", "startmasternode", &startmasternode, true, true, false},
        {"drip", "createmasternodekey", &createmasternodekey, true, true, false},
        {"drip", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"drip", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"drip", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"drip", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"drip", "getmasternodescores", &getmasternodescores, true, true, false},
        {"drip", "mnbudget", &mnbudget, true, true, false},
        {"drip", "preparebudget", &preparebudget, true, true, false},
        {"drip", "submitbudget", &submitbudget, true, true, false},
        {"drip", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"drip", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"drip", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"drip", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"drip", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"drip", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"drip", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"drip", "checkbudgets", &checkbudgets, true, true, false},
        {"drip", "mnsync", &mnsync, true, true, false},
        {"drip", "spork", &spork, true, true, false},
        {"drip", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzdripseed", &getzdripseed, false, false, true},
        {"zerocoin", "setzdripseed", &setzdripseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzdrip", &searchdzdrip, false, false, true},
        {"zerocoin", "dzdripstate", &dzdripstate, false, false, true}
...
{
    return "> drip-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:21462/\n";
}
