...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Drip Core drip-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  drip-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded drip transaction") + "\n" +
                               "  drip-tx [options] -create [commands]   " + _("Create hex-encoded drip transaction") + "\n" +
                               "\n";
