...
#ifndef DRIP_QT_SENDCOINSBTCDIALOG_H
#define DRIP_QT_SENDCOINSBTCDIALOG_H
...
static const int MAX_SENDBTC_POPUP_ENTRIES = 10;
...
class SendCoinsBTCDialog : public QDialog
{
    Q_OBJECT

public:
    explicit SendCoinsBTCDialog(QWidget* parent = 0);
    ~SendCoinsBTCDialog();
...
#endif // DRIP_QT_SENDCOINSBTCDIALOG_H
