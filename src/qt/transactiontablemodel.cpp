...
QString TransactionTableModel::formatTxType(const TransactionRecord* wtx) const
{
    ...
    case TransactionRecord::StakeMint:
        return tr("DRIP Stake");
    case TransactionRecord::StakeZDRIP:
        return tr("zDRIP Stake");
    case TransactionRecord::Generated:
        return tr("Retailer Reward");
    ...
    case TransactionRecord::ZerocoinMint:
        return tr("Converted DRIP to zDRIP");
    case TransactionRecord::ZerocoinSpend:
        return tr("Spent zDRIP");
    case TransactionRecord::RecvFromZerocoinSpend:
        return tr("Received DRIP from zDRIP");
    case TransactionRecord::ZerocoinSpend_Change_zDrip:
        return tr("Minted Change as zDRIP from zDRIP Spend");
    case TransactionRecord::ZerocoinSpend_FromMe:
        return tr("Converted zDRIP to DRIP");
...
QString TransactionTableModel::formatTxToAddress(const TransactionRecord* wtx, bool tooltip) const
{
    ...
    case TransactionRecord::ZerocoinMint:
    case TransactionRecord::ZerocoinSpend_Change_zDrip:
        return tr("Anonymous (zDRIP Transaction)");
    case TransactionRecord::StakeZDRIP:
        return tr("Anonymous (zDRIP Stake)");
    case TransactionRecord::SendToSelf:
    default:
