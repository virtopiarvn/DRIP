                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzDRIPPathCustom = GetArg("-zdripbackuppath", "");
    ...
    if(!strzDRIPPathCustom.empty()) {
        ui->wallet_customzdripbackuppath->setText(QString::fromStdString(strzDRIPPathCustom));
        ui->wallet_customzdripbackuppath_label->setVisible(true);
        ui->wallet_customzdripbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzDRIPPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the DRIP RPC console.") + "<br>" +
