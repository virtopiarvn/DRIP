 ...
 */
    ...
    typeWidget->addItem(tr("Minted"), TransactionFilterProxy::TYPE(TransactionRecord::StakeMint) | TransactionFilterProxy::TYPE(TransactionRecord::StakeZDRIP));
    typeWidget->addItem(tr("Masternode Reward"), TransactionFilterProxy::TYPE(TransactionRecord::MNReward));
    typeWidget->addItem(tr("Received DRIP from zDRIP"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    typeWidget->addItem(tr("Retailer Reward"), TransactionFilterProxy::TYPE(TransactionRecord::Generated));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zDRIP"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zDrip));
