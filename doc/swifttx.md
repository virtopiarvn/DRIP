...
This mechanism has been integrated into Bitcore-Node-DRIP which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/DRIP-Project/insight-api-drip#web-socket-api](https://github.com/DRIP-Project/insight-api-drip#web-socket-api) 
* API: [https://github.com/DRIP-Project/insight-api-drip#swifttx-transactions](https://github.com/DRIP-Project/insight-api-drip#swifttx-transactions) 
...
By default, the DRIP Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the DRIP Core daemon:
