...
In order to support loading of multiple wallets in drip-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is drip.cpp.
...
Changes to drip.cpp
----------------------
drip.cpp is the entry point into drip-qt, and as such, will require some minor modifications to provide hooks for
